...
from src.dashboard.utils.db import get_all_ratios_latest, get_peers
...
fig.update_layout(
    polar={"radialaxis": {"visible": True, "range": [0, 1]}}, showlegend=True
)
...
if bench:
    ...
    table_df = table_df.sort_values("is_benchmark", ascending=False).drop(
